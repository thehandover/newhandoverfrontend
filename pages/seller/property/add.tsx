...
const PropertyAdd: NextPage = ({ textEditorApiKey }: any) => {
  return (
    <>
      <nav
        className="relative w-full flex flex-wrap items-center justify-between py-2 hover:text-gray-700 rounded"
            ...
            <ol className="list-reset flex text-sm">
              ...
              <li>
                <Link href="/seller/properties">
                  <a className="text-black">Properties</a>
                </Link>{" "}
                /&nbsp;
              </li>
              <li>
                <span className="text-gray-500">Add new property</span>
              </li>
            </ol>
          </nav>
        </div>
      ...
      <div className="p-4">
        <div className="my-4 pb-4 flex justify-between items-center border-b border-solid border-gray-300">
          ...
          <div>
            <Link href="/seller/properties">
              <a className="px-4 py-1 bg-black text-white rounded-full transition-all duration-300">
                Properties list
              </a>
            </Link>
          </div>
